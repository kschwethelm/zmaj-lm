...
class TestCreateDecoderMask:
    ...
    def test_shape_without_padding(self) -> None:
        ...
        seq_len = 6
        mask = create_decoder_mask(seq_len, lengths=None)
        assert mask.shape == (1, seq_len, seq_len)
    ...
    def test_shape_with_padding(self) -> None:
        ...
        mask = create_decoder_mask(seq_len, lengths=lengths)
    ...
    def test_causal_property_preserved(self) -> None:
        ...
        mask = create_decoder_mask(5, lengths=lengths)
    ...
    def test_no_padding_equals_causal(self) -> None:
        """Test that with lengths=None, output equals pure causal mask."""
        seq_len = 4
        decoder_mask = create_decoder_mask(seq_len, lengths=None)
    ...
    def test_dtype(self) -> None:
        ...
        mask_bool = create_decoder_mask(4, lengths=lengths, dtype=jnp.bool_)
        assert mask_bool.dtype == jnp.bool_

        mask_int = create_decoder_mask(4, lengths=lengths, dtype=jnp.int32)
        assert mask_int.dtype == jnp.int32
